    ...
    <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-6">
      <div className="flex justify-center">
        <a className="group inline-block bg-white/[.05] hover:bg-white/[.1] border border-white/[.05] p-1 ps-4 rounded-full shadow-md" href="#">
          <p className="me-2 inline-block text-white text-sm mb-2">
      ...
      <div className="max-w-3xl text-center mx-auto">
        <p className="text-lg text-gray-400">Empower Your Financial Choices
for a Secure Future with Financial Nexus.</p>
      </div>
