  ...
  return (
    ...
    <div className="flex flex-col h-full overflow-x-auto mb-4">
              ...
              <div className="grid grid-cols-12 gap-y-2">
                <div className="col-start-1 col-end-8 p-3 rounded-lg">
                  <div className="flex flex-row items-center">
                    <div
                      className="flex items-center justify-center h-10 w-10 rounded-full bg-gray-900 flex-shrink-0"
                    >
                      A
                    </div>
                    <div
                ...
                <div className="col-start-1 col-end-8 p-3 rounded-lg">
                  <div className="flex flex-row items-center">
                    ...
                    >
                      <div className="flex flex-row items-center">
                        <button
                          className="flex items-center justify-center bg-gray-900 hover:bg-indigo-800 rounded-full h-8 w-10"
                        >
                          <svg
          ...
          >
            ...
            <div className="ml-4">
              <Button
                className="flex items-center justify-center bg-gray-900 hover:bg-gray-900 rounded-xl text-white px-4 py-1 flex-shrink-0"
              >
                <span>Send</span>
