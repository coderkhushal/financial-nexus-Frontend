...
const ChatWidget = () => {
  const [chats, setchats] = useState<chattype[]>([
    {
      message: `Hello! My name is FinBOT, and I'm a financial counsellor here to assist you with any questions or concerns you may have. I can provide guidance on a wide range of financial topics, including investments, budgeting, debt management, and more.

Example prompts you could ask me:

- What are some good investment opportunities for beginners?
- How can I create a budget that works for me?
- What are the different types of debt and how can I manage them effectively?
- What are the tax implications of different financial decisions?
